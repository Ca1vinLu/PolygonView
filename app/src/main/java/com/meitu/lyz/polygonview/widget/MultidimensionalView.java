...
import com.meitu.lyz.polygonview.util.ConvertUtils;
...
public class MultidimensionalView extends View {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (paddingTopAndBottom == 0) {
            paddingTopAndBottom = (int) ConvertUtils.dp2px(getContext(), 60);
        }
        inSideLength = height / 2 - paddingTopAndBottom;
        circleRadius = ConvertUtils.dp2px(getContext(), 4);
    ...
    private void init() {
        ...
        mTitlePaint.setTextSize(ConvertUtils.dp2px(getContext(), 14));
        ...
        mBoldLinePaint.setStrokeWidth(ConvertUtils.dp2px(getContext(), 2));
